    ...
    <form class="form-signin" method="post">
        <div class="row">
            <div class="col-7 mx-auto">
                <img class="mb-4" src="assets/viola-logo.svg" alt="" width="100%" height="">
            </div>
        </div>
        <h1 class="h3 mb-3 fw-bold">Inserisci le credenziali</h1>
        <label for="inputEmail" class="sr-only mb-2">Nickname</label>
        <input type="text" id="inputEmail" class="form-control mb-4" placeholder="nickname" name="nickname" required autofocus>

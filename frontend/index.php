                    ...
                    <?php foreach ($list_corsi as $row): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <button id="delete" button type="button" data-bs-toggle="modal" data-bs-target="#elimina"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" id="form">
                        ...
                        <div class="modal fade" id="elimina" tabindex="-1" aria-labelledby="exampleModalLabel"
                                    aria-hidden="true">

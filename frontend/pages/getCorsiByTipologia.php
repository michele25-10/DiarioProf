...
<body>
    ...
    <div class="container mt-5">
        ...
        <h2>I corsi della tipologia: <?php echo $_GET['type'] ?></h2>
        <?php if ($list_corsi != -1) : ?>
                    ...
                    <tbody>
                        <?php foreach ($list_corsi as $row) : ?>
                            <tr>
                                ...
                                <td>
                                    <a href="getInfo.php?id=<?php echo $row['id'] ?>&nome_corso=<?php echo $row['nome_corso'] ?>">
    ...
    <script>
        function filterGlobal() {
            $('#example')
                .DataTable()
                .search($('#global_filter').val(), $('#global_regex').prop('checked'), $('#global_smart').prop(
                    'checked'))
                .draw();
        }

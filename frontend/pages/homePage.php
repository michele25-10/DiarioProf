                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button id="delete" type="button" data-bs-toggle="modal"
                                data-bs-target="#elimina<?php echo $row['id']; ?>" class="btn btn-danger me-1 mb-2">
                            ...
                            <div class="modal fade" id="elimina<?php echo $row['id']; ?>" tabindex="-1"
                            ...
                            <a
                                ...
                                <button class="btn btn-secondary me-1 mb-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"

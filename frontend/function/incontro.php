...
{
    $url = 'http://localhost/DiarioProf/backend/API/incontro/getIncontriNext15Days.php';
...
{
    $url = 'http://localhost/DiarioProf/backend/API/incontro/getStudentIncontro.php?data=' . $date;
